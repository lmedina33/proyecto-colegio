...
$(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_nivel").change(function(){
	...
	get_secciones($(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_nivel").val(),$(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_grado").val(),AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_nivel",AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_seccion","");
});


$(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_grado").change(function(){

	get_secciones($(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_nivel").val(),$(AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_grado").val(),AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_grado",AREA_REGISTROS+CONTENEDOR_ALUMNOS+"#slc_seccion","");
});
...
$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado").change(function(){
	...
	get_secciones($(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_nivel").val(),$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado").val(),AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado",AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_seccion","carga-alumnos");
...
$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_nivel_modif").change(function(){
	...
	get_secciones($(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_nivel_modif").val(),$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado_modif").val(),AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_nivel_modif",AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_seccion_modif","");
});


$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado_modif").change(function(){

	get_secciones($(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_nivel_modif").val(),$(AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado_modif").val(),AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_grado_modif",AREA_REGISTROS+CONTENEDOR_CONSULTAS_ALUMNOS+"#slc_seccion_modif","");
});
