...
<head>
	...
	<script language="javascript" src="../../JS/MODULOS/MODULO_PADRES/INFO_HIJO/funciones_click.js"></script>
	<script language="javascript" src="../../JS/MODULOS/MODULO_PADRES/INFO_HIJO/funciones_post.js"></script>
	<script language="javascript" src="../../JS/MODULOS/MODULO_PADRES/INFO_HIJO/funciones_carga_pagina.js"></script>
	<script language="javascript" src="../../JS/MODULOS/MODULO_PADRES/variables_globales.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="../../CSS/MODULO_PADRES/INFO_HIJO/general.css" media="screen"> 
	<link rel="stylesheet" type="text/css" href="../../CSS/MODULO_PADRES/INFO_HIJO/transiciones_efectos.css" media="screen"> 
	...
	<div id="menu_vertical">
		<div id="titulo_menu">Mis Cursos</div>
			...
			<div id="contenido-opciones">
				...
				<div class="opcion" id="opcion-asistencias" ><div  class="texto_pestana">Asistencias</div></div>
			</div>
...
<input id="codigo_alumno" type="hidden" value="<?php echo $_GET['codigo_alumno']; ?>" />
