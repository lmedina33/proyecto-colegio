...
class DAOGestionBlogProfesor extends Conexion{
	...
	function profesor_registra_entrada($codigo_profesor,$codigo_alumno,$entrada){
		$cn = $this->conexion();
	...
	function profesor_consulta_entrada($codigo_profesor,$codigo_alumno){
		$cn = $this->conexion();
	...
	function profesor_consulta_entrada_por_fecha($codigo_profesor,$codigo_alumno,$fecha){
		$cn = $this->conexion();
