...
class DAOGaleriaFotos extends Conexion{
	...
	function insertar_foto($categoria,$nombre_foto){
		
		$cn = $this->conexion();
        		//$uno=1;
        if($cn!="no_conexion"){
        
        	$sql="insert into $this->nombre_tabla_galeriafotos (categoria,nombre_foto) values ('$categoria','$nombre_foto')";	//Limpiamos la tabla para insertar los nuevos parrafos        
